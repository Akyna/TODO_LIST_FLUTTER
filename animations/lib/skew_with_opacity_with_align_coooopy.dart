...
class SkewWithOpacityWithAlign extends StatefulWidget {
  ...
  static const routeName = '/skew-with-opacity-with-align-copy';
...
class _SkewWithOpacityWithAlignState extends State<SkewWithOpacityWithAlign> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _alignment = _animationController.drive(Tween<Alignment>(begin: Alignment.bottomCenter, end: Alignment.center));
  }
  // vmath.radians(70)
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Center(
          child: ClipRect(
            child: AnimatedSlide(
              offset: _isCollapsed ? Offset.zero : const Offset(0, 0),
              duration: _duration,
