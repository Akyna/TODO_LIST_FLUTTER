...
class _StateWidgetState extends State<StateWidget> {
  ...
  void setColor(Color backgroundColor) {
    final newState = state.copyWith(backgroundColor: backgroundColor);
...
class StateInheritedWidget extends InheritedWidget {
  ...
  static _StateWidgetState of(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<StateInheritedWidget>()!.stateWidget;

  @override
  bool updateShouldNotify(StateInheritedWidget oldWidget) => oldWidget.state != state;
}
